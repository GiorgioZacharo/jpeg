...
void decode_start_f2r_vectorBody_s2e_YuvToRgbExit324(int p, int y_buf[DCTSIZE2], int u_buf[DCTSIZE2], int v_buf[DCTSIZE2], int rgb_buf[4][RGB_NUM][DCTSIZE2]){
